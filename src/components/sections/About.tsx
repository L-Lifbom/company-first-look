        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-slate-600 mb-4">
              Founded in 2023, our company was born out of a passion for creating innovative solutions that address real-world challenges. What began as a small team with big dreams has evolved into a dynamic organization at the forefront of our industry.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-slate-600">
                  To provide innovative solutions that empower our clients to achieve their full potential.
                </p>
              </div>
              <div>
          ...
          <div className="relative bg-slate-100 rounded-lg p-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-sm">
                <span className="text-4xl font-bold text-accent mb-2">500+</span>
              ...
              <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-sm">
                <span className="text-4xl font-bold text-accent mb-2">15+</span>
